...
function LoginForm() {
  ...
  const onSubmit = async () => {
    ...
    if (email === "admin@gmail.com" && password === "1234") {
      ...
      notify("enter valid  email or password", "warn");
    }
  };
  return (
    <Container style={{ minHeight: "83vh" }}>
      <Row className=" m-5 justify-content-center ">
        <Col
          style={{ width: "400px", height: "500px", flex: "none" }}
          className="bg-white p-0 reduceL d-flex flex-column text-center align-items-center  "
        >
          ...
          />
          <Link className="link text-dark mt-4 " to={"/forgotpassword"}>
            Forgot your password?
          </Link>
          <button
            className="text-main my-3 bt2 bg-main my-4"
            onClick={onSubmit}
          >
            SING IN
          </button>
        ...
        <Col
          style={{ width: "400px", height: "500px", flex: "none" }}
          className="bg-main p-0 reduceR creame  d-flex flex-column align-items-center justify-content-center "
        >
