...
import avatar from '../../Images/avatar-06.png'
...
function EditUser() {
    ...
    return (
        <>
            <Row className="m-3 flex-column align-items-center text-center " style={{ minHeight: '78vh' }}>
                ...
                <input
                    ...
                    className="fit reduce my-2"
                />
                <select value={'2'} className='my-2 reduce fit ' onChange={handleChange}>
