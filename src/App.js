    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/admin/allbooksrequests"
            element={<AdminAllBooksReqouestPage />}
          />
          ...
          <Route
            path="/teacher/addattendance"
            element={<TeacherAddAttendancePage />}
          />
          <Route
            path="/teacher/addAssignment"
            element={<TeacherAddAssignmentPage />}
          />
          <Route
            path="/librarian/allevent"
            element={<LibrarianAllEventPage />}
          />
          <Route path="/librarian/addBook" element={<LibrarianAddBookPage />} />
          <Route
            path="/librarian/viewRequestBook"
            element={<LibrarianRequestBookPage />}
          />
